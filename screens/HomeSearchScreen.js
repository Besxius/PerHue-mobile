          ...
          <ScrollView
            ...
            <View style={styles.searchContainer}>
              ...
              {showTip && (
                <View style={styles.tipBanner}>
                  <Text style={styles.tipText}>💡 
                    {t('Tip: Try generating a palette with your favorite movie or theme!')}
                  </Text>
              ...
              <View style={styles.searchInputContainer}>
                <View style={styles.searchBoxRow}>
                  <TextInput
                    ...
                    placeholder={t('Generate a Barbie movie color palette.')}
              ...
              <Text style={styles.microcopy}>
                {t('Describe a mood, theme, or object to generate a palette with AI.')}
              </Text>
            </View>
            {/* Move feature grid and heading to the bottom */}
            <View style={{ height: 32 }} />
            <Text style={styles.featureGridHeadingSubtle}>
              {t('Other ways to create a palette')}
            </Text>
