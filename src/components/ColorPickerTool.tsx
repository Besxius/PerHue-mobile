...
// Mảng màu đã lưu (SAVED COLORS) mặc định
...
// Định nghĩa lại Type và Interface theo yêu cầu
export type Color = {
    id: number;
    name: string;
    hexCode: string;
...
const ColorPickerTool: React.FC<ColorPickerToolProps> = ({
    ...
    onColorSelected,
    initialColorHex,
    colorFilters // Nhận props colorFilters
}) => {
    // *************** VÙNG KHAI BÁO HOOKS (VÔ ĐIỀU KIỆN) ***************

    const insets = useSafeAreaInsets();
    const MODAL_HEIGHT = screenHeight * 0.8;
    // Vị trí y tuyệt đối mà Modal cần đạt được (20% từ trên xuống)
